...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--grid", default="grid.json", help="Grid definition (for fine grid spacing info)")
    parser.add_argument("--remove-grid-lines", action="store_true", default=True, help="Remove fine graph paper lines")
